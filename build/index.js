...
async function getWeatherData(lat, lon) {
    try {
        ...
        const response = await axios.get(`https://api.openweathermap.org/data/3.0/onecall?lat=${lat}&lon=${lon}&exclude=minutely,hourly,alerts&units=metric&lang=zh_cn&appid=${OPENWEATHERMAP_API_KEY}`);
...
// 定义获取天气预报的工具
const getWeatherForecastTool = server.tool("get-forecast", {
